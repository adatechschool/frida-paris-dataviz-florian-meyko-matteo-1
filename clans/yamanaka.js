async function yamanaka()
{
  hideButtonsClans()
    ...
    yamanakaDescription.innerHTML = "Le Clan Yamanaka (山中一族, Yamanaka Ichizoku) est une famille de ninjas de Konoha. Ils possèdent et dirigent un fleuriste dans le village de Konoha."
   const totalPages = 72;
