async function senju()
{
   hideButtonsClans()
    ...
    senjuDescription.innerHTML = "Le clan Senju (千手一族, Senju Ichizoku) était l'un des clans les plus puissants de l'époque, qui avait pour chef, le redoutable et unique utilisateur naturel du Mokuton, Hashirama Senju, qui devint plus tard, le premier Hokage. Ils avaient pour rivaux, le clan Uchiwa dont leur chef, Madara Uchiwa, fut le plus grand et unique rival d'Hashirama Senju. Ils furent à l'origine de la création du village caché des feuilles avec le clan Uchiwa. Il fut également révélé qu'ils auraient des liens de parenté éloignés avec le clan Uzumaki."
   const totalPages = 72;
