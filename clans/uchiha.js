async function uchiha()
{
   hideButtonsClans()
    ...
    uchihaDescription.innerHTML = "Le clan Uchiwa (うちは一族, Uchiha Ichizoku) était autrefois considéré comme le plus puissant clan de Konoha et un des plus puissants du monde ninja (avec pour seul et unique rival le clan Senju avec lequel il fonda Konoha), mais il a maintenant presque disparu après les événements du massacre du clan."
   const totalPages = 72;
