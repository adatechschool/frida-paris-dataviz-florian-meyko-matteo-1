async function akimichi()
{
   hideButtonsClans()
    ...
    akimichiDescription.innerHTML = "Le Clan Akimichi (秋道一族, Akimichi Ichizoku) est un des grands clans de Konoha.[1] Ses membres sont capables de convertir rapidement les calories en chakra, qu'ils utilisent ensuite pour leurs techniques secrètes, telles le Décuplement et les autres variantes de jutsu d'agrandissement du corps. Ils ont eu quinze chefs, Chôza Akimichi en est le chef actuel. Chôji Akimichi est désigné pour devenir le seizième chef.."
   const totalPages = 72;
